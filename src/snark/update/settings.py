"""Load update settings from $HOME/.snark/snark-settings.toml."""
...
from snark.update.paths import settings_path

DEFAULT_REPOSITORY = "davidtgillard/snark"
DEFAULT_RELEASE_TAG = "dev"
DEFAULT_CHECK_INTERVAL_HOURS = 24
DEFAULT_TIMEOUT_SECONDS = 10
DEFAULT_ASSET_PATTERN = "snark-{version}-linux-x86_64"
